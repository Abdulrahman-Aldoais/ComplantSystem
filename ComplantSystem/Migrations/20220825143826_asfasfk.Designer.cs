...
namespace ComplantSystem.Migrations
{
    ...
    [Migration("20220825143826_asfasfk")]
    partial class asfasfk
    {
            ...
            modelBuilder.Entity("ComplantSystem.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a5e392f5-5e29-472f-bec7-2dc62feb9866",
                            ConcurrencyStamp = "4fb3a8b2-fced-45ba-85c8-d31bb9429f15",
                            Name = "AdminGeneralFederation",
                            NormalizedName = "ADMINGENERALFEDERATION"
                        },
                        new
                        {
                            Id = "c257705b-162b-42ad-a888-2c918edfba0a",
                            ConcurrencyStamp = "0366cebb-18bd-450d-9462-4b7d4f59e991",
                            Name = "AdminGovernorate",
                            NormalizedName = "ADMINGOVERNORATE"
                        },
                        new
                        {
                            Id = "597a129a-08ae-4055-a614-e05cf56f5eb1",
                            ConcurrencyStamp = "70e1a720-7143-4926-8872-6e8a6bc43949",
                            Name = "AdminDirectorate",
                            NormalizedName = "ADMINDIRECTORATE"
                        },
                        new
                        {
                            Id = "2958cfef-2dd9-4337-9cfc-78f6a0e64e04",
                            ConcurrencyStamp = "e859d491-2a28-40ec-899a-86e389887914",
                            Name = "AdminSubDirectorate",
                            NormalizedName = "ADMINSUBDIRECTORATE"
                        },
                        new
                        {
                            Id = "1b87e3c5-fe9e-456f-98ca-40a55d6b1971",
                            ConcurrencyStamp = "dcb3faa1-ad3a-41f1-a2ab-fd266d44b14c",
                            Name = "AdminVillages",
                            NormalizedName = "ADMINVILLAGES"
                        },
                        new
                        {
                            Id = "ed412ee2-50ad-4f5e-ae56-1b1c8cbf7e6c",
                            ConcurrencyStamp = "fa424e83-481c-4829-a862-c1da21697ad5",
                            Name = "Beneficiarie",
            ...
            modelBuilder.Entity("ComplantSystem.Models.TypeComplaint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "b2b36c8c-08a8-4845-8c50-abcf63ce8669",
                            CreatedDate = new DateTime(2022, 8, 25, 17, 38, 25, 64, DateTimeKind.Local).AddTicks(3643),
                            Type = "زراعية"
                        },
                        new
                        {
                            Id = "b4e5a529-6673-4261-852a-7d4d402f19c3",
                            CreatedDate = new DateTime(2022, 8, 25, 17, 38, 25, 64, DateTimeKind.Local).AddTicks(4323),
                            Type = "فساد"
                        },
                        new
                        {
                            Id = "0de8a99c-f9bc-446a-bf60-f18f36715cbe",
                            CreatedDate = new DateTime(2022, 8, 25, 17, 38, 25, 64, DateTimeKind.Local).AddTicks(4350),
                            Type = "مماطلة"
                        },
                        new
                        {
                            Id = "6d3ebdee-40e4-4daa-8e08-26da84b6d577",
                            CreatedDate = new DateTime(2022, 8, 25, 17, 38, 25, 64, DateTimeKind.Local).AddTicks(4360),
                            Type = "إرتشاء"
                        });
                });
